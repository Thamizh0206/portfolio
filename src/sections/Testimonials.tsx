...
import { Star, ChevronLeft, ChevronRight, Briefcase, GraduationCap, Award } from 'lucide-react';
...
export function Testimonials() {
  ...
  return (
    <section id="experience" className="w-full py-24 lg:py-32 bg-[#0a0a0f]">
      <div ref={sectionRef} className="container-large px-6 lg:px-12">
        ...
        >
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            {/* Image Side */}
            <div className="relative aspect-[4/5] lg:aspect-[3/4] overflow-hidden bg-white/5 rounded-lg">
              ...
              <div className="absolute top-6 left-6">
                <div className="w-12 h-12 bg-black/60 backdrop-blur-sm rounded-full flex items-center justify-center border border-white/20">
                  {(() => {
                    const IconComponent = iconMap[activeIndex % iconMap.length];
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-center justify-between pt-4">
                ...
                <div className="flex gap-2">
                  <button
                    onClick={prevSlide}
                    className="w-10 h-10 border border-white/20 rounded-full flex items-center justify-center hover:border-blue-500 hover:bg-blue-500 hover:text-white transition-all duration-300 text-white"
